...
**Doc ID**: 1740562287852546
**Path**: API Reference/Catalog Products/Update products

---

Use this endpoint to update products in a catalog in batch and you can update up to 5000 products at a time. The products specified in the request will be updated asynchronously, and you will get a task processing ID, `feed_log_id`. With this ID you can view the processing status via the [/catalog/product/log/](https://ads.tiktok.com/marketing_api/docs?id=1740570027173889) endpoint.

Different from [/catalog/product/file/](https://ads.tiktok.com/marketing_api/docs?id=1740496787164161), this endpoint is mainly used for updating a small number of products and updating some fields.
...
|---|---|---|
|Endpoint path| /v1.2/catalog/product/update/| /v1.3/catalog/product/update/|
...
|New request parameter|/|For E-commerce catalogs:
...
`ipad_app_store_id` 
 ...
 `custom_label_2`
  `custom_label_3`  
`custom_label_4`
For hotel catalogs: all available parameters
For flight catalogs: all available parameters
For destination catalogs: all available parameters
For Auto-Inventory catalogs: all available parameters
For Auto-Model catalogs: all available parameters 
For mini series catalogs: all available parameters|
|Response parameter data type|`feed_log_id`: number|`feed_log_id`: string|
```

## Request

**Endpoint**  https://business-api.tiktok.com/open_api/v1.3/catalog/product/update/
...
| feed_id | string | Catalog feed ID. |
...
The parameters in the `products` object array vary based on the type of catalog you want to upload products to. You can determine the type of a catalog according to `catalog_type` returned from [/catalog/get/](https://ads.tiktok.com/marketing_api/docs?id=1740315452868610). To find the parameters you can pass to the `products` object array, refer to the parameter lists below. 

### `products` object array parameters for E-commerce catalogs 
```xtable
| Field {30%}| Data Type {15%}| Description {55%}|
|---|---|---|
|products {Required} |object[] |List of products that you want to update. 
...
Example: 12433. |
#| product_detail  | object | Product other information. |
##| condition | string | The current condition of the product in your store. 
Enum values: 
- `NEW`: new.
...
##| landing_page_url | string | URL of the landing page where you can view and purchase the product. 
 Example: `https://www.tiktok.com/tiktok_t_shirt`. |
...
#| brand | string | The brand name of the hotel. 
Length limit: 150 characters. |
#| image_url | string | The URL for the hotel room image. 
...
##| address | string | Full name of the primary street address of hotel. 
...
Length limit: 150 characters. |
##| country  | string | The country where the hotel is located. 
Length limit: 150 characters. |
...
#| price_info | object | Price information. |
##| price | float | The base price for one night in the hotel room. 
Example: 30. |
##| currency | string | Unit of currency. 
 If specified, this field must follow the catalog's target country. 
 If this field is not specified, the unit of currency for the catalog's target country will be used by default. 
...
#| image_url  | string | The URL for the flight image. 
The image must be 500x500 px or larger in size. Otherwise, the image will be filtered out, and the product will not be approved. For details, see [Product Image Requirements](https://ads.tiktok.com/marketing_api/docs?id=1739578479392770). 
All images should be in JPG or PNG format. 
...
#|image_url  |string |The URL for the destination image. 
The image must be 500x500 pixels or larger in size. Images smaller than this size will be filtered out, and the product will not be approved. For details, see [Product Image Requirements](https://ads.tiktok.com/marketing_api/docs?id=1739578479392770). 
All images should be in JPG or PNG format. 
...
Length limit: 150 characters. |
##|region  |string |The region (state/province) where the destination is located. 
 Length limit: 150 characters. |
...
#| title | string | The name of the media title item. 
...
Length limit: 10,000 characters. |
#| image_url  | string |The URL for the image of the media title item. 
...
#|title |string|The name of the vehicle.
...
#|image_url |string|The URL for the image of the vehicle, in the format of `http://xxx` or `https://xxx`.
...
**Note**: To remove the video URL associated with the vehicle, set this field to null or `""`. |
...
- `HYBRID`: hybrid.
- `OTHER`: other.|
#|address |object|Address information about the dealership.

The catalog's targeting country will be used as the default country for the dealership.|
##|address |string|The address of the dealership.

Length limit: 150 characters.|
##|city |string|The city where the dealership is located.

Length limit: 150 characters.|
##|region |string|The region (state or province) where the dealership is located.

Length limit: 150 characters.|
##|postal_code |string|The postal code for the dealership's address.

Length limit: 150 characters.|
#|latitude |float|The latitude of the dealership's address.

Value range: [-90, 90].

Example: 37.484100|
#|longitude |float|The longitude of the dealership's address.
...
#|landing_page |object|Landing page information.|
##|landing_page_url |string|URL of the landing page where you can view and purchase the vehicle.
...
Example: 2025.|
#|exterior_color |string|The color of the vehicle.
...
#|landing_page |string|Landing page information.|
##|landing_page_url |string|URL of the landing page where you can view the vehicle listing.
...
**Note**: To remove the video URL associated with the short drama series, set this field to null or `""`. |
#|recharge|object[]|Information about the recharge for the short drama series. 
 
**Note**: Specifying this field will overwrite all fields within the object array.|
...
#|product_detail |string|Additional information about the short drama series.|
...
Value range: 1-9,999.|
##|initial_paid_episodes |number|The episode number at which viewers are required to pay to continue watching the short drama series. For instance, if payment starts from the 11th episode, set this field to 11.
...
| `FAMILY_BOUNDS` | family bounds | Stories focusing on family relationships, conflicts, and emotional bonds. |
...
(code curl http)
    ...
    -d '{\"bc_id\": BC_ID,\"catalog_id\": CATALOG_ID,\"feed_id\": FEEDS_ID,\"products\": [\"DPA_PRODUCTS\"]}' \
